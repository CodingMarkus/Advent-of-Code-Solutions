...
# Run as:
# cat advent_19_2_sample.txt | sh advent_19_2.sh
# cat advent_19_2_input.txt  | sh advent_19_2.sh
...
do
	...
	[ $blueprintCount -lt $maxBlueprints ] || break
done
...
do
	...
	buildSomething 0 0 0 0 1 0 0 0 32

	product=$(( product * bestGeo ))
done
